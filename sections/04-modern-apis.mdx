...
import { Buffering, Link, Prefetch } from '../components'
...
<!-- TODO: Show IntersectionObserver example -->
...
- ✅ Load (larger) images once they enter the viewport
- ✅ Prefetch the page(s) in the background once they enter the viewport
